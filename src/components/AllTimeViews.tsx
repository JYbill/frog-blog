...
const AllTimeViews = () => {
  ...
  return (
    <div className="transform hover:scale-[1.01] transition-all border dark:border-gray-800 rounded p-4 w-full bg-white dark:bg-gray-900">
      ...
      <h3 className="text-lg font-bold text-left mt-2 text-gray-900 dark:text-gray-100">All-Time Views</h3>
      <p className="mt-1 text-gray-700 dark:text-gray-400">{views ? formatViews(views) : "-"}</p>
    </div>
  );
};
