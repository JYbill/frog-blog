...
const ThemeSwitcher = () => {
  ...
  return (
    <button
      ...
      type="button"
      className="w-9 h-9 bg-gray-200 rounded-lg dark:bg-gray-600 flex items-center justify-center hover:ring-2 ring-gray-300 transition-all absolute -right-[10px] top-[20px]"
      onClick={() => changeTheme()}
    >
      <svg
